...
function EthTradingSignals() {
    ...
    useEffect(() => {
        const fetchOHLCV = async () => {
            try {
                const response = await axios.get('https://min-api.cryptocompare.com/data/v2/histoday?fsym=ETH&tsym=USDT&limit=200');
    ...
    return (
        <div>
            <p>Ethereum Trade Signal: <strong>{signal}</strong></p>
...
export default EthTradingSignals;
