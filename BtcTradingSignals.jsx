...
function BtcTradingSignals() {
    ...
    useEffect(() => {
        const fetchOHLCV = async () => {
            try {
                const response = await axios.get('https://min-api.cryptocompare.com/data/v2/histoday?fsym=BTC&tsym=USDT&limit=200');
    ...
    return (
        <div>
            <p>Bitcoin Trade Signal: <strong>{signal}</strong></p>
...
export default BtcTradingSignals;
